...
'debugbar.queries.explain','dashboard','landingpage','login.google',
'login.googlecallback','profile.edit','profile.update','profile.destroy',
...
'LOG_LEVEL','GOOGLE_CLIENT_ID','GOOGLE_CLIENT_SECRET','DB_CONNECTION','DB_HOST',
'DB_PORT','DB_DATABASE','DB_USERNAME','DB_PASSWORD','NODE_ENV',
'VITE_APP_ENV','SESSION_DRIVER','SESSION_LIFETIME','SESSION_ENCRYPT','SESSION_PATH',
